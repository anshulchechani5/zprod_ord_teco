		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Production Order Teco",
									"targetURL": "#zprotecozproductionorderteco-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zprotecozproductionorderteco-display": {
								"semanticObject": "zprotecozproductionorderteco",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zproteco.zproductionorderteco",
									"url": sap.ui.require.toUrl("zproteco/zproductionorderteco")
								}
							}
						}
					}
